  ...
  <table id="marcas">
      ...
      <tbody class="table-grid">
          <tr>
            ...
            <td></td>
              <td>
                  <a id="myBtn" class="btn-datagrid" ><i class="fas fa-pen-square icono-accion"></i>Actualizar</a>
                  <a class="btn-datagrid"><i class="fas fa-trash-alt icono-accion"></i>Eliminar</a>
